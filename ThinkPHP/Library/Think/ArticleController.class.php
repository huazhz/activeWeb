...
//         }
    	...
    	//var_dump($_POST);
		//存入document 表里的数据
    	$data = array('title'=>$_POST['title'],'description'=>$_POST['description'],'status'=>1,'name'=>$_POST['name'],'type'=>$_POST['type'],'display'=>$_POST['display'],'level'=>$_POST['level'],'cover_id'=>$_POST['cover_id'],'view'=>$_POST['view'],'comment'=>$POST['comment'],'create_time'=>$_POST['creat_time'],'deadline'=>$_POST['deadline'],'pid'=>$_POST['pid'],'model_id'=>$_POST['model_id'],'category_id'=>$_POST['category_id']);
